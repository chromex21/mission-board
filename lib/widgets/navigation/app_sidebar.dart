          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    if (_isExpanded) {
                      ...
                      widget.onNavigate('/missions/history');
                    }
                  },
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: widget.currentRoute.startsWith('/missions/history')
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(
                          Icons.history,
                          color:
                              widget.currentRoute.startsWith(
                                '/missions/history',
                              )
                              ? AppTheme.primaryPurple
                              : AppTheme.grey400,
                ...
                if (_isExpanded && _isHistoryExpanded) ...[
                  Padding(
                    ...
                    child: Column(
                      children: [
                        _buildSubNavItem(
                          ...
                          label: 'Today',
                          route: '/missions/history?filter=today',
                        ),
                        _buildSubNavItem(
                          icon: Icons.date_range,
                          label: 'This Week',
                          route: '/missions/history?filter=week',
                        ),
                        _buildSubNavItem(
                          icon: Icons.calendar_month,
                          label: 'This Month',
                          route: '/missions/history?filter=month',
                        ),
                      ],
                    ),
                  ),
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(
              icon,
              color: isActive ? AppTheme.primaryPurple : AppTheme.grey600,
              size: 16,
            ),
